            ...
            <div class="container">
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item"><a href="{{route('front.about-us')}}" class="nav-link">About Us</a></li>
                        <li class="nav-item"><a href="{{route('front.contact-us')}}" class="nav-link">Contact Us</a></li>
                    </ul>
                </div>
            </div>
        </div>
